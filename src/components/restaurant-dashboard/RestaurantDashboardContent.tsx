            ...
            {isMealsLoading ? (
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {filteredMeals.map((meal) => (
                  <Card
                    key={meal.id}
                    className='group rounded-none border-4 border-charcoal bg-white shadow-[8px_8px_0px_0px_rgba(10,10,10,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(10,10,10,1)] transition-all overflow-hidden flex flex-col'>
