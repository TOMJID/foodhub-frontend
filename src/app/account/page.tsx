...
import { User, Package, LogOut, Mail, Calendar, Loader2 } from "lucide-react";
            ...
            <Tabs defaultValue='profile' className='w-full'>
              ...
              <div className='mt-8'>
                <TabsContent value='profile' className='space-y-8'>
                  <Card className='md:col-span-2 rounded-none border-4 border-charcoal bg-white shadow-[8px_8px_0px_0px_rgba(255,87,34,1)]'>
                    <CardHeader>
